...
<template>
  <article
    class="relative overflow-hidden rounded-[17px] border px-6 pb-5 pt-6 text-[var(--home-weather-text)]"
    :style="{
      ...cardStyle,
  ...
  >
    ...
    <template v-else>
      ...
      <div class="relative z-[1] flex items-end justify-between gap-2">
        ...
        >
          <div class="text-[0.72rem] font-bold text-[var(--home-weather-muted)]">{{ hour.label }}</div>
