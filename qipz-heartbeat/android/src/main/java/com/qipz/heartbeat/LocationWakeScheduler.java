...
public final class LocationWakeScheduler {
  ...
  private static final long UPDATE_INTERVAL_MOVE_MS = 2_000L;
  private static final long UPDATE_INTERVAL_SIGNIFICANT_MS = 30_000L;
  ...
  public static void enable(Context context) {
    ...
    try {
      ...
      HeartbeatDebug.markError(context, "location_wake_permission_denied");
    } catch (Exception e) {
      HeartbeatDebug.markError(context, "location_wake_register_failed:" + e.getClass().getSimpleName());
    }
  }
